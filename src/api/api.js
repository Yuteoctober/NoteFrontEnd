...
export const getCard = (setCardResult, userId) => {
    axios.get(`https://notebackend4.onrender.com/card/cards/${userId}`)
    .then((result) => {
...
export const getCheckList = (setCheckListResult, userId) => {
    axios.get(`https://notebackend4.onrender.com/checklist/checklists/${userId}`)
    .then((result) => {
...
export const getUser = (userId, setGetUsername, setAvatar, setLock) => {
  axios.get(`https://notebackend4.onrender.com/auth/username/${userId}`,)
    .then((result) => {
